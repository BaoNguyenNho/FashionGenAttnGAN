...
def build_super_images(real_imgs, captions, ixtoword,
    ...
    for i in range(num):
        ...
        # print ("attn shape and num_attn", attn.shape, num_attn)
        #
        img = real_imgs[i]
        if lr_imgs is None:
            lrI = img
        ...
        for j in range(num_attn):
            ...
            if (vis_size // att_sze) > 1:
                ...
                one_map = one_map[..., :3] 
            # print ('one_map', one_map.shape)
            # print ('vis size', vis_size)
            # print('att sze', att_sze)                                 
            ...
            if maxVglobal < maxV:
                maxVglobal = maxV
        # print('row_beforeNorm', len(row_beforeNorm), row_beforeNorm[0].shape)
